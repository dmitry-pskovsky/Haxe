...
@:keep @:bind #if display private #end class __ASSET__fonts_clearsans_bold_ttf extends flash.text.Font { }
...
@:keep #if display private #end class __ASSET__fonts_clearsans_bold_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "fonts/ClearSans-Bold.ttf"; #end name = "Clear Sans Bold"; super (); }}
